...
<x-layout>
    ...
    @if (Auth::check() && auth()->user()->Admin == 1)
        <a href="/zoznam_studentov" class="ml-6 block bg-blue-600 text-white py-2 rounded-xl hover:opacity-80 text-center"
    ...
    <div class="mx-4">
        <x-card class="p-10 max-w-2xl mx-auto mt-6">
            <div class="grid-container">
                <div class="item1">
                    <img class="w-48 border border-black-200 rounded mb-4"
                ...
                <div class="item3">
                    <div>
                        ...
                        <a href="mailto:{{ $listing->email }}" class="hover:text-laravel"><i
