@if (Auth::check() && auth()->user()->Povereny_pracovnik)
    <x-layout>
        ...
        <a href="/nexus_povereny" class="ml-6 block bg-blue-600 text-white py-2 rounded-xl hover:opacity-80 text-center"
            style="width: 80px;"><i class="fa-solid fa-arrow-left"></i> Naspäť </a>
        ...
        <x-card class="p-10 max-w-5xl mx-auto mt-6">
            ...
            <input class="form-control" type="text" id="myInput" placeholder="Hľadať ..."
                onkeyup="searchTableColumns()">
                        ...
                        @foreach ($listings as $listing)
                            ...
                            <tr class="border-gray-300">
                                <td class="py-2 text-l border-b">
                                   <a class="hover:text-red-500"> {{ $listing->company }}</a>
                                </td>
