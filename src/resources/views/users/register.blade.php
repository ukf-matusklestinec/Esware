            ...
            <div class="text-center">
                ...
                <div class="mb-4">
                    <label for="odbor" class="inline-block text-lg mb-2">Odbor<span style="color:red;">
                            *</label></label>
                    <select name="odbor" id="id" class="border border-gray-200 rounded p-2 w-half"
                        style="width: 350px; margin-left: 68.63px;">
                ...
                <div>
                    <label for="password_confirmation" class="inline-block text-lg mb-2">Potvrdiť heslo<span
                            style="color:red;"> *</label>
                    <input type="password" class="border border-black-200 rounded p-2 w-full"
                        name="password_confirmation" value="{{ old('password_confirmation') }}"
                        style="width: 350px; margin-left: 9.1px;" />
