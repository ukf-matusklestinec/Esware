    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: '# Mestá ponúk',
                    data: [{{$nitra}}, {{$vrable}}, {{$zvolen}}, {{$levice}}, {{$zilina}}, {{$bratislava}}],
                    backgroundColor: [
                        'rgba(255,7,7,0.4)',
                        'rgba(10,96,245,0.4)',
                        'rgba(26,248,10,0.4)',
        ...
        var myChartX = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Informatika aplikovaná', 'Informatika učiteľstvo', 'Fyzika', 'Fyzika materialov', 'Fyzika učiteľstvo', 'Matematika učiteľstvo',
                    'Informačné metódy v ekonómii a finančníctve', 'Geografia v regionálnom rozvoji', 'Geografia učiteľstvo', 'Chemia učiteľstvo', 'Biologia', 'Biologia učiteľstvo'],
                datasets: [{
                    label: '# Mestá ponúk',
                    data: [{{$IA}}, {{$IU}}, {{$F}}, {{$FM}}, {{$FU}}, {{$MU}},
                        {{$IMEF}}, {{$G}}, {{$GU}}, {{$CHU}}, {{$B}}, {{$BU}}],
                    backgroundColor: [
                        'rgba(255,7,7,0.4)',
                        'rgba(10,96,245,0.4)',
        ...
        var myChart2 = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [{{$admin}}, {{$veduci}}, {{$povereny}}, {{$zastupca}}],
                    backgroundColor: [
                        'rgba(89,9,245,0.4)',
                        'rgba(241,230,12,0.4)',
                        'rgba(15,245,245,0.4)',
